...
<Tip>
    Once you're happy with the cards you've created, you're to export the deck to your favorite spaced repetition app.
</Tip>
...
Sub-decks can be defined by creating a slash (`/`) separated path from the outer most deck to inner most deck: `<Deck>/<Sub-Deck>/<Sub-Sub-Deck>`
