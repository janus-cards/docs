...
| Task                                                                                                                                                                                       | User Prompt                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Generating new or additional flashcards for a single highlight in [highlights](/workflow/notebook/highlights) tab or [document reader](/workflow/notebook/document-reader). ![](/imgs/generate-button.png) | **Prompt you input**                                                                                                                                       |
| Requesting to change or improve your flashcards for a single highlight ![](/imgs/improve%20button.png)                                                                                     | **Prompt you input**                                                                                                                                       |
| Running an [edit command](/workflow/notebook/highlights#edit-commands) ![](/imgs/refinement.png)                                                                                                    | **Refinement prompt**                                                                                                                                      |
| Called by the **Highlighter** after running the [Generator](/workflow/notebook/generate) ![](/imgs/generate-tab-input.png)                                                                          | **Part of the prompt you input.** The highlighter determines which parts of the original prompt are relevant for that particular highlight, and uses that. |
